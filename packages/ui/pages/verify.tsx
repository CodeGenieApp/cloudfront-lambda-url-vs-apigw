...
export default function VerifyPage() {
  ...
  return (
    <UnauthenticatedPage pageTitle="Verify Account">
      ...
      {queryParamCode ? null : (
        <p>
          Check your inbox for a verification email that includes a verification code, and enter it here. Alternatively, simply click the
          link in the email.
        </p>
      )}
      <Form layout="vertical" name="verifyAccountForm" form={form} onFinish={verifyAccountMutation.mutate}>
        <Form.Item
          label="Email"
          name="email"
          required={false}
